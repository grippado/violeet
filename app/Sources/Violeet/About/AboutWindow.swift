    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 7) {
                ...
                row(
                    "Repository",
                    link: "https://github.com/grippado/violeet",
                    label: "github.com/grippado/violeet"
                )
...
enum BuildInfo {
    ...
    static var commit: String? {
        let value = Bundle.main.object(forInfoDictionaryKey: "VioleetGitCommit") as? String
