// violeet — native macOS terminal for running several AI coding agents as tabs.
//
// The app is a dumb client of violeet-daemon: it renders sessions and sends
// commands over the Unix socket at ~/.violeet/daemon.sock. It computes no token
...
struct VioleetApp: App {
    ...
    var body: some Scene {
        ...
        .commands { VioleetCommands(state: state) }
    }
}

// MARK: - Menu commands

private struct VioleetCommands: Commands {
    ...
    var body: some Commands {
        ...
        CommandGroup(replacing: .appInfo) {
            Button("About violeet") { AboutWindow.show(state: state) }
        }
