...
func directoryNamesATabWithNothingElse() {
    let name = SessionName.resolve(NameInputs(cwd: "/Users/grippado/www/personal/aiterm"))
    #expect(name.text == "aiterm")
...
func agentTitleBeatsTheDirectory() {
    let name = SessionName.resolve(
        NameInputs(
            ...
            cwd: "/Users/grippado/www/personal/aiterm"
        )
    )
...
func manualBeatsDirectory() {
    let name = SessionName.resolve(
        NameInputs(manualName: "onda 2", cwd: "/Users/grippado/www/personal/aiterm")
    )
    #expect(name.text == "onda 2")
    #expect(name.source == .manual)
}
...
func directoryUnderHomeKeepsItsName() {
    ...
    #expect(SessionName.directoryName(home + "/www/personal/aiterm") == "aiterm")
}
...
func shellsAreNotNames() {
    ...
    let name = SessionName.resolve(
        NameInputs(foregroundProcess: "-zsh", cwd: "/Users/grippado/www/personal/aiterm")
    )
    #expect(name.text == "aiterm")
    #expect(name.source == .directory)
}
...
func oscTitleExpiresWithItsProcess() {
    var input = NameInputs(
        ...
        oscTitle: "SessionName.swift (aiterm)",
        oscProcess: "vim",
        cwd: "/Users/grippado/www/personal/aiterm"
    )
    #expect(SessionName.resolve(input).text == "SessionName.swift (aiterm)")
...
func oscTitleFromTheShellIsIgnored() {
    ...
    let input = NameInputs(
        ...
        oscTitle: "grippado@worzix: ~/www/personal/aiterm",
        oscProcess: "zsh",
        cwd: "/Users/grippado/www/personal/aiterm"
    )
