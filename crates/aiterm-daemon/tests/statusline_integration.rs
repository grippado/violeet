...
use aiterm_daemon::http::StatusLinePayload;
use aiterm_daemon::registry::{Harness, HookObservation, Registry};
...
///
/// A session aiterm has not seen through a hook has no tab binding and no
