...
//! in the `violeet-transcript` crate, which knows nothing about sockets or the
...
/// The protocol's Rust projection, re-exported from `violeet-proto`.
///
